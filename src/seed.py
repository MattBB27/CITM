...
VEHICLES = [
    # vehicle_id (rego), model, manufacturer, type, mileage
    ("BTM-447", "Corolla",    "Toyota",     "Sedan",     18500),
    ("CRX-892", "Camry",      "Toyota",     "Sedan",     32100),
    ("HZP-103", "RAV4",       "Toyota",     "SUV",       27400),
    ("MNL-728", "HiLux",      "Toyota",     "Ute",       45200),
    ("FRD-561", "Ranger",     "Ford",       "Ute",       38700),
    ("PMA-209", "Puma",       "Ford",       "SUV",       12300),
    ("WTQ-845", "Mondeo",     "Ford",       "Sedan",     55800),
    ("CXM-376", "CX-5",       "Mazda",      "SUV",       21600),
    ("MZD-118", "3",          "Mazda",      "Hatchback", 9800),
    ("BTU-694", "BT-50",      "Mazda",      "Ute",       61200),
    ("TCN-273", "Tucson",     "Hyundai",    "SUV",       14700),
    ("HYD-405", "i30",        "Hyundai",    "Hatchback", 8400),
    ("CRT-918", "Cerato",     "Kia",        "Sedan",     11200),
    ("SPK-562", "Sportage",   "Kia",        "SUV",       23900),
    ("KCV-307", "Carnival",   "Kia",        "Van",       33600),
    ("MOT-839", "Outlander",  "Mitsubishi", "SUV",       48300),
    ("ASX-150", "ASX",        "Mitsubishi", "SUV",       17100),
    ("TRT-682", "Triton",     "Mitsubishi", "Ute",       72400),
    ("SBR-294", "Impreza",    "Subaru",     "Hatchback", 6900),
    ("FRS-715", "Forester",   "Subaru",     "SUV",       29700),
]
